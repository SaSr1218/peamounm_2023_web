...
public class Ex4_배열 {
	public static void main(String[] args) {
		...
		System.out.println(" 배열내 첫번쨰 : " + season[0] );
		System.out.println(" 배열내 두번쨰 : " + season[1] );
		System.out.println(" 배열내 세번쨰 : " + season[2] );
		System.out.println(" 배열내 네번쨰 : " + season[3] );
		// 오류 : System.out.println(" 배열내 다섯번쨰 : " + season[4] ); 인덱스 길이가 4인데 4번째 length를 꺼내려함
			// 3. 인덱스내 데이터 변경
		season[1] = "여름";
		System.out.println(" 배열내 두번째 : " + season[1]);
			// 4. 반복과 배열 관계
		for ( int i = 0 ; i<season.length; i++ ) { System.out.println( i + " : " + season[i]); }
...
/*
 	...
 	p.165
 		...
 		- 1. 선언
 			1. 자료형타입[ ] 배열명 = { 허용범위내데이터3 , 허용범위내데이터2 , 허용범위내데이터3 }  허용범위 = 타입의 허용범위
 			2. 자료형타입[ ] 배열명 = new 자료형타입[길이];
 			
 				초기값
 					- int[] scores = new int[3];
 					자료형 :	int int int
 					데이터 :	0	0	0		(int 초기값 = 0이기때문)
 					인덱스 : 	0	1	2
