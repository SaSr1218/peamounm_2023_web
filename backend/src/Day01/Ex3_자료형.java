...
public class Ex3_자료형 {
	public static void main(String[] args) {
		...
		long l2 = 10000000000L;	System.out.println("long자료형 :" + l2); 	// 뒤에 타입 'L'을 입력해야 오류 발생하지 않음.
			// 정수 기본타입 : int 이다.		변수에 저장되기전 자료형이 명시되지 않은 데이터 
		...
		// 8. [ p.47 ] float/double 자료형
			// float 데이터 뒤에 f 붙여야 사용가능!
		...
		// boolean bool2 = 2;		// 오류발생 : true 혹은 false만 저장 가능
