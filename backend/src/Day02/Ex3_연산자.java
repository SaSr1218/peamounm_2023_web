...
public class Ex3_연산자 {
	public static void main(String[] args) {
		...
		System.out.println(" x < y " + ( x < y) ); 		// +12 < -12
		System.out.println(" x <= y " + ( x <= y) ); 	// +12 <= -12
		System.out.println(" strl.equals(str2) : " + ( "유재석".equals("유재석") ) ); // 유재석 == 유재석
		System.out.println(" !strl.equals(str2) : " + ( !"유재석".equals("유재석") ) ); // 유재석 != 유재석"
		
		// 4. 논리연산자 [ p.91 ]
		System.out.println(" 5<x<20 : " + ( x>5 && x <20 ) );		// x = 12, true 
		System.out.println(" 5<x<10 : " + ( x>5 && x <10 ) );		// x = 12, false
		System.out.println(" 0<=x x>=20 : " + ( x<=0 || x>=20 ) );	// x = 12, false
		System.out.println(" 0<=x x>=10 : " + ( x<=0 || x>=10 ) );	// x = 12, true
		System.out.println(" !(x == y) : " +  ( !(x==y) ) );		// x = 12, false
