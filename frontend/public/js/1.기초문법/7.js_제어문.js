...
// 1. if 형태1
 ...
 if( 10 > 20 ); console.log('[참2] 10이 더 크다.') // [틀린 예시] 

 // 2. if 형태2
 if( 10 > 3 ) console.log('참1'); console.log('1.10이 더 크다.'); // [x] 2번째 console은 if랑 상관없이 무조건 실행됨 
 if( 10 > 20 ) console.log('참2'); console.log('2.10이 더 크다.'); // [x] 2번째 console은 if랑 상관없이 무조건 실행됨
 ...
 else if( 10 >= 15 ) { console.log( '[참3] 10이 10보다 이상.')}		// 아니면서 만약에 10>=10 이상이면
...
Question
	...
	2. prompt로 성별 입력받아 
		'M' 또는 'm' 또는 '남'또는 '남자' 일 경우 '남자 이군요' 출력
		'W' 또는 'w' 또는 '남'또는 '남자' 일 경우 '남자 이군요' 출력
		그외 '남자 : m,M,남,남자		여자:w,W,여,여자 로 입력해주세요'라고 console. cnffur
...
if( 정수2 >= 90 ) { console.log('A등급'); }
else if( 정수2 >= 80 ){ console.log('B등급'); }
else if( 정수2 >= 70 ){ console.log('C등급'); }
else { console.log('탈락'); }
