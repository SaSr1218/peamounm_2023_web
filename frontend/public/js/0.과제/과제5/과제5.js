...
let burgerList = [ 
	...
	{ name : '치킨킹팩' , price : 13000 , img : '치킨킹팩.png' , category : '스페셜' } 
]
// 카트 등록된 '버거객체' 목록/배열 
let cartList = [  ] // 카트 목록
// '주문객체' 목록/배열 
...
function sales_rank( index ) {
	...
	burgerList.forEach( (burger, i) => {
		...
		// 3. 비교 [ 만약에 index번째 버거의 매출액보다 현재 반복되는 버거의 i번째 버거의 매출액보다 작으면 rank 증가]
